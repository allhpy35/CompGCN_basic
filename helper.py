...
def get_logger(name, log_dir, config_dir):
	...
	config_dict['handlers']['file_handler']['filename'] = log_dir + name.replace('/', '-') + '.txt'
...
def cconv(a, b):
	...
	return torch.fft.irfft(com_mult(torch.fft.rfft(a, 1), torch.fft.rfft(b, 1)), n=a.shape[-1], dim=1, norm='backward')
	#torch.fft.irfft(com_mult(torch.fft.rfft(a, 1), torch.fft.rfft(b, 1)), n=a.shape[-1], dim=1, norm='ortho')
...
def ccorr(a, b):
	...
	return torch.fft.irfft(com_mult(conj(torch.fft.rfft(a, 1)), torch.fft.rfft(b, 1)), n=a.shape[-1], dim=1, norm='backward')


	#torch.fft.irfft(com_mult(conj(torch.fft.rfft(a, 1)), torch.fft.rfft(b, 1)), n=a.shape[-1], dim=1, norm='ortho' )
